#!/usr/bin/env bash
#
# EC2 user-data bootstrap: installs Java 21 + Jenkins LTS on Ubuntu 24.04.
#
# Runs once, as root, on first boot. Everything it prints goes to
# /var/log/jenkins-bootstrap.log so a failed run can be diagnosed later.
#
